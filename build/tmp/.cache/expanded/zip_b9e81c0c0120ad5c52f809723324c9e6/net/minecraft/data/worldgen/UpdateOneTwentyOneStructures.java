...
public class UpdateOneTwentyOneStructures {
    public static void bootstrap(BootstrapContext<Structure> p_335898_) {
        HolderGetter<Biome> holdergetter = p_335898_.lookup(Registries.BIOME);
        HolderGetter<StructureTemplatePool> holdergetter1 = p_335898_.lookup(Registries.TEMPLATE_POOL);
        p_335898_.register(
