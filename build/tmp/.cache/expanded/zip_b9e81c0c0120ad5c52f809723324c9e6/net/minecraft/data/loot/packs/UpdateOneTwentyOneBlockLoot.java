...
public class UpdateOneTwentyOneBlockLoot extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(Blocks.TUFF_SLAB, p_309884_ -> this.createSlabItemTable(p_309884_));
        this.add(Blocks.TUFF_BRICK_SLAB, p_312067_ -> this.createSlabItemTable(p_312067_));
        this.add(Blocks.POLISHED_TUFF_SLAB, p_312759_ -> this.createSlabItemTable(p_312759_));
        ...
        this.add(Blocks.COPPER_DOOR, p_310248_ -> this.createDoorTable(p_310248_));
        this.add(Blocks.EXPOSED_COPPER_DOOR, p_310936_ -> this.createDoorTable(p_310936_));
        this.add(Blocks.WEATHERED_COPPER_DOOR, p_311974_ -> this.createDoorTable(p_311974_));
        this.add(Blocks.OXIDIZED_COPPER_DOOR, p_312652_ -> this.createDoorTable(p_312652_));
        this.add(Blocks.WAXED_COPPER_DOOR, p_311328_ -> this.createDoorTable(p_311328_));
        this.add(Blocks.WAXED_EXPOSED_COPPER_DOOR, p_310922_ -> this.createDoorTable(p_310922_));
        this.add(Blocks.WAXED_WEATHERED_COPPER_DOOR, p_310816_ -> this.createDoorTable(p_310816_));
        this.add(Blocks.WAXED_OXIDIZED_COPPER_DOOR, p_310706_ -> this.createDoorTable(p_310706_));
