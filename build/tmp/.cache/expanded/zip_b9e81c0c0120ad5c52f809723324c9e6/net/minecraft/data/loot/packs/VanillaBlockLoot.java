...
public class VanillaBlockLoot extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(
            ...
            p_325866_ -> createSilkTouchDispatchTable(
                    p_325866_,
                    (LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(
                        p_325866_,
        ...
        this.add(
            Blocks.COBWEB, p_250546_ -> createSilkTouchOrShearsDispatchTable(p_250546_, (LootPoolEntryContainer.Builder<?>)this.applyExplosionCondition(p_250546_, LootItem.lootTableItem(Items.STRING)))
        );
        this.add(
            Blocks.DEAD_BUSH,
        ...
        this.add(
            Blocks.GLOWSTONE,
            p_325869_ -> createSilkTouchDispatchTable(
                    p_325869_,
                    (LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(
                        p_325869_,
        ...
        this.add(
            Blocks.MELON,
            p_325874_ -> createSilkTouchDispatchTable(
                    p_325874_,
                    (LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(
                        p_325874_,
        ...
        this.add(
            Blocks.SEA_LANTERN,
            p_325873_ -> createSilkTouchDispatchTable(
                    p_325873_,
                    (LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(
                        p_325873_,
                                    ...
                                    LootItem.lootTableItem(Items.NETHER_WART)
                                        .apply(
                                            SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))
                                                .when(
                                                    LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_325867_)
        ...
        this.add(
            Blocks.GRAVEL,
            p_325872_ -> createSilkTouchDispatchTable(
                    p_325872_,
                    this.applyExplosionCondition(
                        p_325872_,
                        LootItem.lootTableItem(Items.FLINT)
                            ...
                            .otherwise(LootItem.lootTableItem(p_325872_))
                    )
                )
        );
        this.add(
        ...
        this.add(
            ...
            p_325871_ -> createSilkTouchDispatchTable(
                    p_325871_,
                    this.applyExplosionCondition(
                        p_325871_,
                        LootItem.lootTableItem(Items.GOLD_NUGGET)
                            ...
                            .when(BonusLevelTableCondition.bonusLevelFlatChance(Enchantments.FORTUNE, 0.1F, 0.14285715F, 0.25F, 1.0F))
                            .otherwise(LootItem.lootTableItem(p_325871_))
                    )
                )
        );
        this.add(
        ...
        this.add(
            ...
            p_325868_ -> createSilkTouchDispatchTable(
                    p_325868_,
                    LootItem.lootTableItem(Items.AMETHYST_SHARD)
                        ...
                        .otherwise(
                            (LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(
                                p_325868_, LootItem.lootTableItem(Items.AMETHYST_SHARD).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F)))
                            )
                        )
                )
        );
