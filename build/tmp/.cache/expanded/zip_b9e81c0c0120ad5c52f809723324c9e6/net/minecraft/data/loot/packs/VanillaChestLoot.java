...
public class VanillaChestLoot implements LootTableSubProvider {
    @Override
    public void generate(HolderLookup.Provider p_329114_, BiConsumer<ResourceKey<LootTable>, LootTable.Builder> p_250931_) {
        p_250931_.accept(
    ...
    public static void spawnerLootTables(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> p_312949_) {
        p_312949_.accept(BuiltInLootTables.SPAWNER_TRIAL_CHAMBER_KEY, LootTable.lootTable());
        p_312949_.accept(BuiltInLootTables.SPAWNER_TRIAL_CHAMBER_CONSUMABLES, LootTable.lootTable());
        p_312949_.accept(BuiltInLootTables.SPAWNER_OMINOUS_TRIAL_CHAMBER_KEY, LootTable.lootTable());
        p_312949_.accept(BuiltInLootTables.SPAWNER_OMINOUS_TRIAL_CHAMBER_CONSUMABLES, LootTable.lootTable());
        p_312949_.accept(BuiltInLootTables.SPAWNER_TRIAL_ITEMS_TO_DROP_WHEN_OMINOUS, LootTable.lootTable());
    }
