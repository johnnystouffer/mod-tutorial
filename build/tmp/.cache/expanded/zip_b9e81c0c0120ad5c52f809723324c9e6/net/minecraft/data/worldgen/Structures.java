...
public class Structures {
    ...
    public static void bootstrap(BootstrapContext<Structure> p_329393_) {
        ...
        p_329393_.register(BuiltinStructures.IGLOO, new IglooStructure(structure(holdergetter.getOrThrow(BiomeTags.HAS_IGLOO), TerrainAdjustment.NONE)));
        p_329393_.register(
        ...
        p_329393_.register(BuiltinStructures.END_CITY, new EndCityStructure(structure(holdergetter.getOrThrow(BiomeTags.HAS_END_CITY), TerrainAdjustment.NONE)));
        p_329393_.register(
