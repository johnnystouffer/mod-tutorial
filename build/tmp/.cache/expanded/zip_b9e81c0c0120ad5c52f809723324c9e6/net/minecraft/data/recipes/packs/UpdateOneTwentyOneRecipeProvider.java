...
public class UpdateOneTwentyOneRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput p_310714_) {
        ...
        smithingTrims().forEach(p_334633_ -> trimSmithing(p_310714_, p_334633_.template(), p_334633_.id()));
        copySmithingTemplate(p_310714_, Items.FLOW_ARMOR_TRIM_SMITHING_TEMPLATE, Items.BREEZE_ROD);
        copySmithingTemplate(p_310714_, Items.BOLT_ARMOR_TRIM_SMITHING_TEMPLATE, Items.COPPER_BLOCK);
