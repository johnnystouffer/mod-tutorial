...
public class VanillaFishingLoot implements LootTableSubProvider {
    @Override
    public void generate(HolderLookup.Provider p_328914_, BiConsumer<ResourceKey<LootTable>, LootTable.Builder> p_249559_) {
        HolderLookup.RegistryLookup<Biome> registrylookup = p_328914_.lookupOrThrow(Registries.BIOME);
        p_249559_.accept(
