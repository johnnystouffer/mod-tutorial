...
public class TradeRebalanceChestLoot implements LootTableSubProvider {
    @Override
    public void generate(HolderLookup.Provider p_331875_, BiConsumer<ResourceKey<LootTable>, LootTable.Builder> p_301336_) {
        p_301336_.accept(
            ...
            LootTable.lootTable()
                ...
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.BOOK).setWeight(1).apply(new EnchantRandomlyFunction.Builder().withEnchantment(Enchantments.EFFICIENCY))
                        )
                )
        );
        p_301336_.accept(BuiltInLootTables.ANCIENT_CITY, ancientCityLootTable());
        p_301336_.accept(BuiltInLootTables.DESERT_PYRAMID, desertPyramidLootTable());
        p_301336_.accept(BuiltInLootTables.JUNGLE_TEMPLE, jungleTempleLootTable());
        p_301336_.accept(BuiltInLootTables.PILLAGER_OUTPOST, pillagerOutpostLootTable());
    }
