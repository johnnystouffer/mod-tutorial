...
public abstract class BiomeData {
    public static void bootstrap(BootstrapContext<Biome> p_333300_) {
        ...
        p_333300_.register(Biomes.SWAMP, OverworldBiomes.swamp(holdergetter, holdergetter1, p_329782_ -> {
        }));
        p_333300_.register(Biomes.MANGROVE_SWAMP, OverworldBiomes.mangroveSwamp(holdergetter, holdergetter1, p_331723_ -> {
        }));
