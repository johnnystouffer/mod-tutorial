    ...
    public MultiLineTextWidget(int p_270325_, int p_270355_, Component p_270069_, Font p_270673_) {
        ...
        this.cache = Util.singleKeyCache(
            p_270516_ -> p_270516_.maxRows.isPresent()
                    ? MultiLineLabel.create(p_270673_, p_270516_.message, p_270516_.maxWidth, p_270516_.maxRows.getAsInt())
                    : MultiLineLabel.create(p_270673_, p_270516_.message, p_270516_.maxWidth)
        );
        this.active = false;
    }
