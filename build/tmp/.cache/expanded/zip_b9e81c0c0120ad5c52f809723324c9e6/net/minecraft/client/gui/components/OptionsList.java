...
public class OptionsList extends ContainerObjectSelectionList<OptionsList.Entry> {
    ...
    public OptionsList(Minecraft p_94465_, int p_94466_, int p_94467_, OptionsSubScreen p_333471_) {
        super(p_94465_, p_94466_, p_333471_.layout.getContentHeight(), p_333471_.layout.getHeaderHeight(), 25);
        this.centerListVertically = false;
        this.screen = p_333471_;
    }
    ...
    protected static class OptionEntry extends OptionsList.Entry {
        ...
        public static OptionsList.OptionEntry big(Options p_335438_, OptionInstance<?> p_329713_, OptionsSubScreen p_334802_) {
        ...
        public static OptionsList.OptionEntry small(
            ...
            return p_331704_ == null
                ...
                : new OptionsList.OptionEntry(ImmutableMap.of(p_330233_, abstractwidget, p_331704_, p_331704_.createButton(p_330617_)), p_334257_);
        }
    }
}