...
public class IntegratedServer extends MinecraftServer {
    ...
    @Override
    public void reportChunkLoadFailure(ChunkPos p_335057_) {
        this.warnOnLowDiskSpace();
        SystemToast.onChunkLoadFailure(this.minecraft, p_335057_);
    }

    @Override
    public void reportChunkSaveFailure(ChunkPos p_328809_) {
        this.warnOnLowDiskSpace();
        SystemToast.onChunkSaveFailure(this.minecraft, p_328809_);
    }
}
