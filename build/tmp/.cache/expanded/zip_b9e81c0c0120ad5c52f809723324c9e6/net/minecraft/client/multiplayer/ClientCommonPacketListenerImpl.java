...
public abstract class ClientCommonPacketListenerImpl implements ClientCommonPacketListener {
    ...
    public void onDisconnect(Component p_298766_) {
        ...
        this.minecraft.disconnect(this.createDisconnectScreen(p_298766_), this.isTransferring);
        LOGGER.warn("Client disconnected with reason: {}", p_298766_.getString());
    }
    ...
    protected Screen createDisconnectScreen(Component p_299787_) {
        ...
        return (Screen)(this.serverData != null && this.serverData.isRealm()
            ? new DisconnectedRealmsScreen(screen, GENERIC_DISCONNECT_MESSAGE, p_299787_)
            : new DisconnectedScreen(screen, GENERIC_DISCONNECT_MESSAGE, p_299787_));
    }
