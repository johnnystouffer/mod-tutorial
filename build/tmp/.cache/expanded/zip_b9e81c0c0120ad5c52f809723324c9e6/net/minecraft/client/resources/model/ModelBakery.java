...
public class ModelBakery {
    ...
    static <T extends Comparable<T>> T getValueHelper(Property<T> p_119277_, String p_119278_) {
        return p_119277_.getValue(p_119278_).orElse(null);
    }
    ...
    class ModelBakerImpl implements ModelBaker {
        ...
        ModelBakerImpl(final BiFunction<ResourceLocation, Material, TextureAtlasSprite> p_249651_, final ResourceLocation p_251408_) {
    ...
    static class ModelGroupKey {
        ...
        public boolean equals(Object p_119395_) {
            if (this == p_119395_) {
                ...
                return !(p_119395_ instanceof ModelBakery.ModelGroupKey modelbakery$modelgroupkey)
                    ? false
