...
public abstract class ArrowRenderer<T extends AbstractArrow> extends EntityRenderer<T> {
    ...
    public void vertex(
        ...
        p_253902_.vertex(p_327779_, (float)p_254058_, (float)p_254338_, (float)p_254196_)
            .color(255, 255, 255, 255)
            .uv(p_254003_, p_254165_)
            .overlayCoords(OverlayTexture.NO_OVERLAY)
            .uv2(p_254271_)
            .normal(p_327779_, (float)p_253982_, (float)p_254038_, (float)p_254037_)
            .endVertex();
    }
}