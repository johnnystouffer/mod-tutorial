...
public class DecoratedPotRenderer implements BlockEntityRenderer<DecoratedPotBlockEntity> {
    ...
    @Nullable
    private static Material getMaterial(Optional<Item> p_328463_) {
        if (p_328463_.isPresent()) {
            Material material = Sheets.getDecoratedPotMaterial(DecoratedPotPatterns.getResourceKey(p_328463_.get()));
            if (material != null) {
                return material;
            }
        }
    ...
    public void render(DecoratedPotBlockEntity p_273776_, float p_273103_, PoseStack p_273455_, MultiBufferSource p_273010_, int p_273407_, int p_273059_) {
        ...
        this.renderSide(this.frontSide, p_273455_, p_273010_, p_273407_, p_273059_, getMaterial(potdecorations.front()));
        this.renderSide(this.backSide, p_273455_, p_273010_, p_273407_, p_273059_, getMaterial(potdecorations.back()));
        this.renderSide(this.leftSide, p_273455_, p_273010_, p_273407_, p_273059_, getMaterial(potdecorations.left()));
        this.renderSide(this.rightSide, p_273455_, p_273010_, p_273407_, p_273059_, getMaterial(potdecorations.right()));
        p_273455_.popPose();
    }
    ...
    private void renderSide(ModelPart p_273495_, PoseStack p_272899_, MultiBufferSource p_273582_, int p_273242_, int p_273108_, @Nullable Material p_273173_) {
        if (p_273173_ == null) {
            p_273173_ = getMaterial(Optional.empty());
        }
