...
public class EntityRenderDispatcher implements ResourceManagerReloadListener {
    ...
    private static void renderHitbox(PoseStack p_114442_, VertexConsumer p_114443_, Entity p_114444_, float p_114445_) {
        ...
        p_114443_.vertex(posestack$pose, 0.0F, p_114444_.getEyeHeight(), 0.0F)
            .color(0, 0, 255, 255)
            .normal(posestack$pose, (float)vec31.x, (float)vec31.y, (float)vec31.z)
            .endVertex();
        p_114443_.vertex(
                posestack$pose, (float)(vec31.x * 2.0), (float)((double)p_114444_.getEyeHeight() + vec31.y * 2.0), (float)(vec31.z * 2.0)
            )
            .color(0, 0, 255, 255)
            .normal(posestack$pose, (float)vec31.x, (float)vec31.y, (float)vec31.z)
            .endVertex();
    ...
    private static void fireVertex(
        ...
        p_114416_.vertex(p_114415_, p_114417_, p_114418_, p_114419_)
            .color(255, 255, 255, 255)
            .uv(p_114420_, p_114421_)
            .overlayCoords(0, 10)
            .uv2(240)
            .normal(p_114415_, 0.0F, 1.0F, 0.0F)
            .endVertex();
    }
    ...
    private static void shadowVertex(
        PoseStack.Pose p_114423_,
        VertexConsumer p_114424_,
        float p_114425_,
        float p_114426_,
        float p_114427_,
        float p_114428_,
        ...
        p_114424_.vertex(
            vector3f.x(), vector3f.y(), vector3f.z(), 1.0F, 1.0F, 1.0F, p_114425_, p_114429_, p_114430_, OverlayTexture.NO_OVERLAY, 15728880, 0.0F, 1.0F, 0.0F
        );
    }
