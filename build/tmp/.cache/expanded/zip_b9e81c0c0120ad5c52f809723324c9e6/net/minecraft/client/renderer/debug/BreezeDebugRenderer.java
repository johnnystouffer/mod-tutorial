            ...
            .forEach(
                p_325541_ -> {
                    ...
                    optional.map(BreezeDebugPayload.BreezeInfo::attackTarget)
                        ...
                        .ifPresent(
                            p_310972_ -> {
                                drawLine(p_311387_, p_310722_, p_312623_, p_310151_, p_312438_, p_325541_.position(), p_310972_, TARGET_LINE_COLOR);
                    ...
                    optional.map(BreezeDebugPayload.BreezeInfo::jumpTarget)
                        .ifPresent(
                            p_325534_ -> {
                                drawLine(p_311387_, p_310722_, p_312623_, p_310151_, p_312438_, p_325541_.position(), p_325534_.getCenter(), JUMP_TARGET_LINE_COLOR);
