...
public class GuiGraphics implements net.minecraftforge.client.extensions.IForgeGuiGraphics {
    ...
    public void fillRenderType(RenderType p_327925_, int p_328209_, int p_335424_, int p_329528_, int p_336385_, int p_332231_) {
        ...
        vertexconsumer.vertex(matrix4f, (float)p_328209_, (float)p_335424_, (float)p_332231_).endVertex();
        vertexconsumer.vertex(matrix4f, (float)p_328209_, (float)p_336385_, (float)p_332231_).endVertex();
        vertexconsumer.vertex(matrix4f, (float)p_329528_, (float)p_336385_, (float)p_332231_).endVertex();
        vertexconsumer.vertex(matrix4f, (float)p_329528_, (float)p_335424_, (float)p_332231_).endVertex();
        this.flushIfUnmanaged();
    }
