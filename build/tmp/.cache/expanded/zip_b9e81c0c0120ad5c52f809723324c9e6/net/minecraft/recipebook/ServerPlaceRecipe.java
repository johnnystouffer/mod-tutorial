...
public class ServerPlaceRecipe<C extends Container> implements PlaceRecipe<Integer> {
    ...
    public void recipeClicked(ServerPlayer p_135435_, @Nullable RecipeHolder<? extends Recipe<C>> p_298963_, boolean p_135437_) {
        if (p_298963_ != null && p_135435_.getRecipeBook().contains(p_298963_)) {
            ...
            if (this.testClearGrid() || p_135435_.isCreative()) {
                ...
                if (this.stackedContents.canCraft((Recipe<?>)p_298963_.value(), null)) {
    ...
    protected void handleRecipeClicked(RecipeHolder<? extends Recipe<C>> p_298652_, boolean p_135442_) {
        ...
        if (this.stackedContents.canCraft((Recipe<?>)p_298652_.value(), intlist, j1)) {
            int k = j1;
            ...
            if (this.stackedContents.canCraft((Recipe<?>)p_298652_.value(), intlist, k)) {
                this.clearGrid();
