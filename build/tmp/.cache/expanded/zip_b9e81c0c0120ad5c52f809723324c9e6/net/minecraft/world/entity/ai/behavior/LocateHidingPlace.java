                    ...
                    .apply(
                        ...
                        (p_258484_, p_258485_, p_258486_, p_258487_, p_258488_, p_258489_, p_258490_) -> (p_326848_, p_326849_, p_326850_) -> {
                                p_326848_.getPoiManager()
                                    ...
                                    .filter(p_326856_ -> p_326856_.closerToCenterThan(p_326849_.position(), (double)p_259982_))
                                    .or(
                                        () -> p_326848_.getPoiManager()
                                                .getRandom(
                                    ...
                                    .ifPresent(p_326867_ -> {
                                        ...
                                        if (!p_326867_.closerToCenterThan(p_326849_.position(), (double)p_259982_)) {
                                            p_258484_.set(new WalkTarget(p_326867_, p_259881_, p_259982_));
                                        }
                                    });
                                return true;
                            }
