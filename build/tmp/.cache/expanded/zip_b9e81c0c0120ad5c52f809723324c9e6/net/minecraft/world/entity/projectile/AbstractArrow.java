...
public abstract class AbstractArrow extends Projectile {
    ...
    protected AbstractArrow(EntityType<? extends AbstractArrow> p_36717_, Level p_36719_, ItemStack p_312639_) {
        ...
        this.setCustomName(p_312639_.get(DataComponents.CUSTOM_NAME));
        Unit unit = p_312639_.remove(DataComponents.INTANGIBLE_PROJECTILE);
        if (unit != null) {
    ...
    protected AbstractArrow(
        EntityType<? extends AbstractArrow> p_36711_, double p_36712_, double p_36713_, double p_36714_, Level p_36715_, ItemStack p_310436_
    ) {
    ...
    protected AbstractArrow(EntityType<? extends AbstractArrow> p_36721_, LivingEntity p_312718_, Level p_36722_, ItemStack p_309639_) {
        this(p_36721_, p_312718_.getX(), p_312718_.getEyeY() - 0.1F, p_312718_.getZ(), p_36722_, p_309639_);
    ...
    public void setEnchantmentEffectsFromEntity(LivingEntity p_36746_, float p_36747_) {
        int i = EnchantmentHelper.getEnchantmentLevel(Enchantments.POWER, p_36746_);
        int j = EnchantmentHelper.getEnchantmentLevel(Enchantments.PUNCH, p_36746_);
