...
public class CreativeModeTabs {
    ...
    private static void generateEnchantmentBookTypesOnlyMaxLevel(
        ...
        FeatureFlagSet p_333671_
    ) {
        p_270903_.listElements()
            .map(Holder::value)
            .filter(p_327123_ -> p_327123_.isEnabled(p_333671_))
            .filter(p_327114_ -> p_270380_.contains(p_327114_.getSupportedItems()))
    ...
    private static void generateEnchantmentBookTypesAllLevels(
        ...
        FeatureFlagSet p_333277_
    ) {
        p_270628_.listElements()
            .map(Holder::value)
            .filter(p_327112_ -> p_327112_.isEnabled(p_333277_))
            .filter(p_327121_ -> p_271024_.contains(p_327121_.getSupportedItems()))
            .flatMap(
