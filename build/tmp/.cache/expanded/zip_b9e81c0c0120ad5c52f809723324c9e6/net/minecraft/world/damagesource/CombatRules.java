...
public class CombatRules {
    ...
    public static float getDamageAfterAbsorb(float p_19273_, DamageSource p_328919_, float p_19274_, float p_19275_) {
        float f = 2.0F + p_19275_ / 4.0F;
        float f1 = Mth.clamp(p_19274_ - p_19273_ / f, p_19274_ * 0.2F, 20.0F);
        float f2 = f1 / 25.0F;
        float f3 = EnchantmentHelper.calculateArmorBreach(p_328919_.getEntity(), f2);
        float f4 = 1.0F - f3;
        return p_19273_ * f4;
    }
