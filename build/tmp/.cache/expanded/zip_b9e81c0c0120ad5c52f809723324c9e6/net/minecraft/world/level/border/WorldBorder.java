...
public class WorldBorder {
    ...
    public boolean isWithinBounds(AABB p_61936_) {
        return p_61936_.maxX > this.getMinX()
            && p_61936_.minX < this.getMaxX()
            && p_61936_.maxZ > this.getMinZ()
            && p_61936_.minZ < this.getMaxZ();
    }

    public BlockPos clampToBounds(double p_187570_, double p_187571_, double p_187572_) {
        return BlockPos.containing(
            Mth.clamp(p_187570_, this.getMinX(), this.getMaxX()), p_187571_, Mth.clamp(p_187572_, this.getMinZ(), this.getMaxZ())
        );
    }
