...
public class DecoratedPotRecipe extends CustomRecipe {
    ...
    public ItemStack assemble(CraftingContainer p_334623_, HolderLookup.Provider p_328495_) {
        PotDecorations potdecorations = new PotDecorations(
            p_334623_.getItem(1).getItem(), p_334623_.getItem(3).getItem(), p_334623_.getItem(5).getItem(), p_334623_.getItem(7).getItem()
        );
