...
public class ItemEnchantments implements TooltipProvider {
    ...
    public int getLevel(Enchantment p_334964_) {
        return this.enchantments.getInt(p_334964_.builtInRegistryHolder());
    }
    ...
    public static class Mutable {
        ...
        public void set(Enchantment p_334196_, int p_330613_) {
            if (p_330613_ <= 0) {
                this.enchantments.removeInt(p_334196_.builtInRegistryHolder());
            } else {
                this.enchantments.put(p_334196_.builtInRegistryHolder(), Math.min(p_330613_, 255));
            }
        }

        public void upgrade(Enchantment p_328282_, int p_332549_) {
            if (p_332549_ > 0) {
                this.enchantments.merge(p_328282_.builtInRegistryHolder(), Math.min(p_332549_, 255), Integer::max);
            }
        }
        ...
        public int getLevel(Enchantment p_330501_) {
            return this.enchantments.getOrDefault(p_330501_.builtInRegistryHolder(), 0);
        }
