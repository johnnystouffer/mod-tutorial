        ...
        return BehaviorBuilder.create(
            p_259997_ -> p_259997_.group(
                    ...
                    .apply(p_259997_, (p_259831_, p_259115_, p_259521_, p_259223_) -> (p_326823_, p_326824_, p_326825_) -> {
                            ...
                            boolean flag = blockpos.closerThan(p_326824_.blockPosition(), (double)p_259740_);
                            if (!flag) {
                                BehaviorUtils.setWalkAndLookTargetMemories(p_326824_, getNearbyPos(p_326824_, blockpos), p_259957_, p_259740_);
                            }
