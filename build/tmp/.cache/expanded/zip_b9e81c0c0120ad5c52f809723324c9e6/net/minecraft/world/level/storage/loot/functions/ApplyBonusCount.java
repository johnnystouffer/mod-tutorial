...
public class ApplyBonusCount extends LootItemConditionalFunction {
    ...
    public static LootItemConditionalFunction.Builder<?> addBonusBinomialDistributionCount(Enchantment p_79918_, float p_79919_, int p_79920_) {
        return simpleBuilder(p_297062_ -> new ApplyBonusCount(p_297062_, p_79918_.builtInRegistryHolder(), new ApplyBonusCount.BinomialWithBonusCount(p_79920_, p_79919_)));
    }

    public static LootItemConditionalFunction.Builder<?> addOreBonusCount(Enchantment p_79916_) {
        return simpleBuilder(p_297064_ -> new ApplyBonusCount(p_297064_, p_79916_.builtInRegistryHolder(), new ApplyBonusCount.OreDrops()));
    }

    public static LootItemConditionalFunction.Builder<?> addUniformBonusCount(Enchantment p_79940_) {
        return simpleBuilder(p_297068_ -> new ApplyBonusCount(p_297068_, p_79940_.builtInRegistryHolder(), new ApplyBonusCount.UniformBonusCount(1)));
    }

    public static LootItemConditionalFunction.Builder<?> addUniformBonusCount(Enchantment p_79922_, int p_79923_) {
        return simpleBuilder(p_297071_ -> new ApplyBonusCount(p_297071_, p_79922_.builtInRegistryHolder(), new ApplyBonusCount.UniformBonusCount(p_79923_)));
    }
